...
if __name__ == "__main__":
    ...
    if create_training_dataset:
        datasets = {
            ...
            "CAF": Dataset_Batch(annotation_path = f"{DATA_DIR}/CAF_annoatations.xlsx",
        ...
        for seq_len_iter in [SEQ_LEN]:
            align_and_save_dataset(spots_df,
                                ...
                                output_prefix="CAF_dataset")
        
        build_track_level_dataset(tracks_df, datasets=datasets, output_prefix="CAF")   

        save_unscaled_spot_features(spots_df, output_prefix="CAF")
        save_unscaled_track_features(tracks_df, datasets=datasets, output_prefix="CAF")
