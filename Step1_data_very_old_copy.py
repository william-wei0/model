...
def load_annotations(path, annotation_type):
    ...
    match annotation_type:
        ...
        case _:
            raise Exception("Undefined Data loading type. Specify how to load the annotations")
...
if __name__ == "__main__":
    create_training_dataset_only = True
    create_test_dataset_only = True

    if create_training_dataset_only:
